...
/// A dollar-amount input field that behaves like a typical point-of-sale
/// or banking app: type digits only, and the decimal point is placed
/// automatically from the right — no need to type "." yourself. Typing "5"
/// then "0" then "0" produces $5.00, not $500.
///
...
/// anywhere a cost field already exists. Double(text) on save works
