...
enum EntryValidation {
    ...
    /// Keep `isBeforeManufactureYear` in Models.swift matching this.
...
extension View {
    ...
    /// disable Save, and clears the selection afterward so the same photo can
    /// be chosen again after being removed.
